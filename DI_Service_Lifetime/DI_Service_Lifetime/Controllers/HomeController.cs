...
namespace DI_Service_Lifetime.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly ISingletonGuideService _singlton1;
        private readonly ISingletonGuideService _singlton2;
        ...
        {
            _singlton1 = singleton1;
            _singlton2 = singleton2;
        ...
        public IActionResult Index()
        {
            ...
            messages.Append($"singleton 1 : {_singlton1.GetGuid()}\n");
            messages.Append($"singleton 2 : {_singlton2.GetGuid()}\n\n");
